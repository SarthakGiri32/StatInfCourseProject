...
In this analysis, the ToothGrowth data will be analyzed, which can be found in the R `datasets` package. This data set contains data on the effects of Vitamin C on the growth of teeth in guinea pigs. Two vitamin C supplements are used, with varying dose levels.
