...
From the two histograms, it is clear that the distribution of 1000 random exponential distributions is not normal, rather it is skewed. On the other hand, the distribution of 1000 means of 40 exponential distributions is really close to the normal distribution, and is the consequence of the Central Limit Theorem, _since the distribution of means contains 1000 means_; and for a sufficiently large sample size, distribution of means of any distribution will approximate to the normal distribution.